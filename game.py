...
ghosts_in_action = {}
ghosts_in_action_right = {}
ghosts_in_action_middle = {}
ghost_goal_position = {}
ghost_goal_position_right=  {}
ghost_goal_position_middle=  {}
motion_list= []
ghosts_in_action_motion = {}
check_motion_start = 0
len_motion = 0
identifier = 0
temp_ghosts_in_action_motion = {}
temp_ghosts_at_rest= [1,2,3,4]
